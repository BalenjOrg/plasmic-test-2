...
import sty from "./PlasmicButtonYes.module.css"; // plasmic-import: KEA691y11_-z/css
...
export type PlasmicButtonYes__VariantMembers = {
...
export type PlasmicButtonYes__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButtonYes__VariantsArgs;
export const PlasmicButtonYes__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButtonYes__ArgsType = {
...
type ArgPropType = keyof PlasmicButtonYes__ArgsType;
export const PlasmicButtonYes__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicButtonYes__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultButtonYesProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicButtonYes__RenderFunc(props: {
  variants: PlasmicButtonYes__VariantsArgs;
  args: PlasmicButtonYes__ArgsType;
  overrides: PlasmicButtonYes__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__coThb)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon6Icon
                className={classNames(projectcss.all, sty.svg___01Pr1)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButtonYes>(
    PlasmicButtonYes,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButtonYes__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButtonYes__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicButtonYes__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicButtonYes__ArgProps,
          internalVariantPropNames: PlasmicButtonYes__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicButtonYes__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonYes";
  } else {
    func.displayName = `PlasmicButtonYes.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonYes = Object.assign(
  // Top-level PlasmicButtonYes renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonYes
    internalVariantProps: PlasmicButtonYes__VariantProps,
    internalArgProps: PlasmicButtonYes__ArgProps,

    useBehavior
  }
);

export default PlasmicButtonYes;
/* prettier-ignore-end */
