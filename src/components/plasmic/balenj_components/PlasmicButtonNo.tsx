...
import sty from "./PlasmicButtonNo.module.css"; // plasmic-import: oPVnB9Uytcc7/css
...
export type PlasmicButtonNo__VariantMembers = {
...
export type PlasmicButtonNo__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButtonNo__VariantsArgs;
export const PlasmicButtonNo__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButtonNo__ArgsType = {
...
type ArgPropType = keyof PlasmicButtonNo__ArgsType;
export const PlasmicButtonNo__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicButtonNo__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultButtonNoProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicButtonNo__RenderFunc(props: {
  variants: PlasmicButtonNo__VariantsArgs;
  args: PlasmicButtonNo__ArgsType;
  overrides: PlasmicButtonNo__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__dyU8D)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon6Icon
                className={classNames(projectcss.all, sty.svg__ltNjV)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButtonNo>(
    PlasmicButtonNo,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButtonNo__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButtonNo__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicButtonNo__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicButtonNo__ArgProps,
          internalVariantPropNames: PlasmicButtonNo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicButtonNo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonNo";
  } else {
    func.displayName = `PlasmicButtonNo.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonNo = Object.assign(
  // Top-level PlasmicButtonNo renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonNo
    internalVariantProps: PlasmicButtonNo__VariantProps,
    internalArgProps: PlasmicButtonNo__ArgProps,

    useBehavior
  }
);

export default PlasmicButtonNo;
/* prettier-ignore-end */
